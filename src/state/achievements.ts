...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  // --- Operations: cargo + charter contracts ---
  { id: 'first-cargo', category: 'operations', icon: '📦', name: 'First cargo delivery',
    description: 'Wheels up with a paying box.',
    target: 1, progress: s => s.stats.cargoDeliveries },
  { id: 'cargo-10', category: 'operations', icon: '📦', name: '10 cargo deliveries',
    description: 'Freight regular.',
    target: 10, progress: s => s.stats.cargoDeliveries },
  { id: 'cargo-100', category: 'operations', icon: '📦', name: '100 cargo deliveries',
    description: 'Logistics powerhouse.',
    target: 100, progress: s => s.stats.cargoDeliveries },
  { id: 'cargo-1m-kg', category: 'operations', icon: '⚓', name: 'Million-kg shipper',
    description: '1,000,000 kg of cargo lifetime.',
    target: 1_000_000, progress: s => s.stats.cargoKgShipped },
  { id: 'cargo-big-pay', category: 'operations', icon: '💼', name: 'Big haul',
    description: 'A single cargo contract cleared $1M+.',
    target: 1_000_000, valueKind: 'money', progress: s => s.stats.cargoBiggestPayment },
  { id: 'first-charter', category: 'operations', icon: '🎟', name: 'First charter',
    description: 'Bulk-seat business is open.',
    target: 1, progress: s => s.stats.charterDeliveries },
  { id: 'charter-10', category: 'operations', icon: '🎟', name: '10 charters delivered',
    description: 'Charter regular.',
    target: 10, progress: s => s.stats.charterDeliveries },
  { id: 'charter-100', category: 'operations', icon: '🎟', name: '100 charters delivered',
    description: 'The charter game is yours.',
    target: 100, progress: s => s.stats.charterDeliveries },
  { id: 'charter-big-group', category: 'operations', icon: '🎟', name: 'Mega charter',
    description: 'Completed a 300+ pax charter.',
    target: 300, progress: s => s.stats.charterBiggestGroup },
